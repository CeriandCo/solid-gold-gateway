...
DROP FUNCTION IF EXISTS public.gift_card_order_settle(uuid, text, text, boolean, text, text, text, text, text);

REVOKE ALL ON FUNCTION public.gift_card_order_settle(uuid, text, boolean, text, text, text, text, text, text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.gift_card_order_settle(uuid, text, boolean, text, text, text, text, text, text) TO service_role;
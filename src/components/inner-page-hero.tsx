...
.inner-page-hero-image--fractional{object-position:right center}.inner-page-hero-image--gifting{object-position:center}.inner-page-hero-image--trust{object-position:right center}.inner-page-hero-image--learn{object-position:right center}.inner-page-hero-image--about{object-position:center}.inner-page-hero-image--pricing{object-position:62% center}
...
.inner-page-hero-shell{position:absolute;z-index:4;inset:0;padding-top:clamp(54px,7vh,76px);padding-bottom:clamp(88px,11vh,120px);padding-inline:calc(max(0px,(100% - var(--container))/2) + var(--gutter))}
...
.inner-page-hero-action-area{min-height:94px;margin-top:auto;padding-top:20px}.inner-page-hero-action-area.no-note{min-height:0}.inner-page-hero-actions{min-height:54px;display:flex;align-items:center;gap:16px}.inner-page-hero-note{height:20px;margin-top:12px;color:color-mix(in srgb,var(--warm-white) 80%,transparent);font-family:"Inter",Arial,sans-serif;font-size:13px;line-height:20px}
...
@media(max-width:767px){.inner-page-hero{height:620px}.inner-page-hero-image{object-position:75% center}.inner-page-hero-image--fractional{object-position:68% center}.inner-page-hero-image--gifting{object-position:66% center}.inner-page-hero-image--trust{object-position:78% center}.inner-page-hero-image--learn{object-position:68% center}.inner-page-hero-image--about{object-position:center}.inner-page-hero-image--pricing{object-position:62% center}.inner-page-hero>.about-hero-mandala{left:-170px;top:30px;width:480px;height:480px}.inner-page-hero>.about-hero-bar{left:auto;right:-45px;top:auto;bottom:-4px;width:390px;height:48%;transform:rotate(4deg)}.inner-page-hero>.kc-play{left:auto;right:24px;top:auto;bottom:24px;translate:0 0;width:64px;height:64px}.inner-page-hero-overlay{background:linear-gradient(90deg,rgba(7,25,15,.98) 0%,rgba(7,25,15,.91) 54%,rgba(7,25,15,.48) 78%,rgba(7,25,15,.18) 100%)}.inner-page-hero-shell{padding:42px 20px 56px}.inner-page-hero-copy{width:100%;max-width:360px}.inner-page-hero-eyebrow{margin-bottom:12px}.inner-page-hero h1{max-width:340px;font-size:clamp(36px,10.7vw,44px)}.inner-page-hero-rule{width:42px;margin-top:18px;margin-bottom:14px}.inner-page-hero-body{min-height:68px;max-width:330px;font-size:15px}.inner-page-hero-action-area{min-height:92px;padding-top:16px}.inner-page-hero-action-area.no-note{min-height:0}.inner-page-hero-actions{gap:10px}.inner-page-hero-actions>a{min-width:0;padding-inline:18px;font-size:12px}.inner-page-hero-note{font-size:12px}}

...
.inner-page-hero-image{position:absolute;inset:0;width:100%;height:100%;object-fit:contain;object-position:right center;animation:innerHeroSettle 1.2s cubic-bezier(.22,1,.36,1) both}
.inner-page-hero-image--fractional{object-position:right center}.inner-page-hero-image--gifting{object-position:center}.inner-page-hero-image--trust{object-position:right center}.inner-page-hero-image--learn{object-position:right center}.inner-page-hero-image--about{object-fit:cover;object-position:center}
...
.inner-page-hero-shell{position:absolute;z-index:4;inset:0;padding:clamp(54px,7vh,76px) clamp(48px,4.5139vw,116px)}
...
@media(max-width:767px){.inner-page-hero{height:620px}.inner-page-hero-image{object-fit:cover;object-position:75% center}.inner-page-hero-image--fractional{object-fit:contain;object-position:right bottom}.inner-page-hero-image--gifting{object-position:66% bottom}.inner-page-hero-image--trust{object-position:right center}.inner-page-hero-image--learn{object-position:68% center}.inner-page-hero-image--about{object-position:center}.inner-page-hero-overlay{background:linear-gradient(90deg,rgba(7,25,15,.98) 0%,rgba(7,25,15,.91) 54%,rgba(7,25,15,.48) 78%,rgba(7,25,15,.18) 100%)}.inner-page-hero-shell{padding:42px 20px 34px}.inner-page-hero-copy{width:100%;max-width:360px}.inner-page-hero-eyebrow{margin-bottom:12px}.inner-page-hero h1{max-width:340px;font-size:clamp(36px,10.7vw,44px)}.inner-page-hero-rule{width:42px;margin-top:18px;margin-bottom:14px}.inner-page-hero-body{min-height:68px;max-width:330px;font-size:15px}.inner-page-hero-action-area{min-height:92px;padding-top:16px}.inner-page-hero-actions{gap:10px}.inner-page-hero-actions>a{min-width:0;padding-inline:18px;font-size:12px}.inner-page-hero-note{font-size:12px}}

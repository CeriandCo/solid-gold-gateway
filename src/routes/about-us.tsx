...
.about-story,.about-process,.about-paths,.about-trust{position:relative;background-color:var(--paper);background-image:radial-gradient(ellipse at 18% 32%,rgba(118,82,27,.06),transparent 42%),linear-gradient(112deg,rgba(255,255,255,.07),transparent 40%,rgba(118,82,27,.035))}.about-story{overflow:hidden}
...
.about-process{height:auto;min-height:405px;padding:30px max(var(--gutter),calc((100% - var(--container))/2 + var(--gutter))) 38px}.about-process .about-shell{width:100%;height:auto}.about-process-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));align-items:stretch;margin-top:8px}.about-process-grid article{min-width:0;min-height:285px;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:24px 34px;border-left:1px solid rgba(151,108,34,.3)}.about-process-grid article:first-child{border-left:0}.about-icon-ring{width:122px;height:122px;display:grid;place-items:center;border:1px solid rgba(177,142,57,.65);border-radius:50%;transition:transform .65s cubic-bezier(.22,1,.36,1)}.about-icon-ring svg{width:69px;height:69px;color:#13251B;stroke:currentColor;stroke-width:1.4}.about-process-grid h2{margin-top:16px;color:#13251B;font-size:clamp(29px,2.7083vw,69px);line-height:1.05}.about-process-grid p{max-width:360px;margin-top:10px;font-size:clamp(14px,1.1806vw,30px);font-weight:400;line-height:1.42;color:var(--ink)}
.about-paths{height:auto;padding:32px var(--gutter) 0}.about-paths .about-shell{width:100%;height:auto}.about-path-grid{width:100%;max-width:1185px;margin:16px auto 0;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:0;align-items:end}.about-path-grid article{box-sizing:border-box;width:100%;min-width:0;min-height:285px;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px clamp(20px,2.9vw,42px);border:1px solid var(--gold-line);border-radius:8px 8px 0 0;text-align:center;color:var(--cream);background:#061E14;transition:transform .22s ease,border-color .22s ease}.about-path-grid article:hover{transform:translateY(-5px);border-color:#C49D46}.about-path-grid article.is-featured{min-height:315px;color:var(--ink);border-color:#C6962C;background:var(--paper);position:relative;z-index:1}.about-path-grid article.is-featured:hover{transform:translateY(-5px);border-color:#D3A638}.about-path-grid svg{width:78px;height:78px;color:var(--gold);stroke:currentColor;stroke-width:1.4}.about-path-grid h2{margin-top:10px;color:var(--gold);font-size:clamp(28px,2.6389vw,67.5px);line-height:1.05}.about-path-grid .is-featured h2{color:var(--gold-deep)}.about-path-grid p{max-width:330px;margin-top:9px;font-size:clamp(13px,1.1111vw,28.5px);font-weight:400;line-height:1.4}.about-path-grid .is-featured p{color:var(--ink)}
...
@media(max-width:1099px) and (min-width:768px){.about-shell{width:calc(100% - 96px)}.about-company .about-shell{width:100%;padding-inline:48px}.about-company-grid article{gap:12px;padding-inline:12px}.about-company-grid h2{font-size:21px}.about-company-grid svg{width:56px;height:56px}.about-process{padding:40px 48px}.about-process-grid article{padding-inline:18px}.about-process-grid p{font-size:13px}.about-paths{padding:40px 48px}.about-path-grid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:stretch;gap:16px}.about-path-grid article,.about-path-grid article.is-featured{min-height:285px;border-radius:8px}.about-path-grid article.is-featured{grid-column:span 2}.about-path-grid p{font-size:14px}.about-trust-inner{max-width:calc(100% - 96px);grid-template-columns:190px minmax(0,1fr);column-gap:28px}.about-trust-copy h2{font-size:28px;white-space:normal}}

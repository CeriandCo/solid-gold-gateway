...
.about-story{height:clamp(334px,32.6389vw,836px)}.about-story-inner{position:relative;width:calc(100% - 142px);height:100%;margin-left:clamp(72px,7.0833vw,181px);padding-block:clamp(50px,4.8611vw,124px);display:grid;grid-template-columns:38% 1px minmax(0,1fr);column-gap:clamp(48px,4.7222vw,121px);align-items:center}.about-story-inner:before{content:"";grid-column:2;grid-row:1;width:1px;height:clamp(238px,23.2639vw,596px);background:rgba(198,150,44,.62);transform-origin:top}.about-story-lead{grid-column:1;grid-row:1;z-index:1}.about-story-lead h2{font-size:clamp(42px,4.1667vw,107px);line-height:1.1;letter-spacing:-.02em;color:var(--gold-deep)}.about-story-lead h2 span{display:block}.about-short-rule{display:block;width:84px;height:1px;margin-top:24px;background:var(--gold-line)}.about-story-copy{grid-column:3;grid-row:1;z-index:1;max-width:600px;font-size:clamp(15px,1.3889vw,35.6px);font-weight:400;line-height:1.52}.about-story-copy p+p{margin-top:20px}.about-story-etch{position:absolute;left:-202px;bottom:-210px;width:450px;opacity:.18;mix-blend-mode:multiply}
.about-company{min-height:clamp(142px,13.8889vw,356px);margin:0;color:var(--cream);background:var(--forest-950);border-bottom:1px solid rgba(216,159,46,.34)}.about-company .about-shell{width:100%;padding:32px 100px 25px}.about-company .about-eyebrow{color:var(--gold)}.about-company-grid{min-height:128px;display:grid;grid-template-columns:repeat(3,1fr)}.about-company-grid article{min-width:0;display:flex;align-items:center;justify-content:center;gap:16px;padding-inline:20px;border-left:1px solid rgba(216,159,46,.36);transition:opacity .65s cubic-bezier(.22,1,.36,1),transform .65s cubic-bezier(.22,1,.36,1)}.about-company-grid article:first-child{padding-left:0;border-left:0}.about-company-grid svg{width:52px;height:52px;flex:none;color:var(--gold);stroke:currentColor;stroke-width:1.4;vector-effect:non-scaling-stroke}.about-company-grid h2{color:var(--cream);font-size:clamp(19px,1.8056vw,46px);line-height:1.1;white-space:nowrap}
.about-compliance{position:relative;height:clamp(276px,26.9444vw,690px);margin:0;padding:0;display:grid;place-items:center;overflow:hidden;color:var(--gold);background:radial-gradient(circle at 50% 18%,rgba(31,79,55,.26),transparent 65%),var(--forest-950)}.about-mandala{position:absolute;top:50%;width:clamp(294px,29.8611vw,765px);height:clamp(294px,29.8611vw,765px);object-fit:contain;opacity:.12;mix-blend-mode:screen}.about-mandala-left{left:clamp(-240px,-9.375vw,-96px);transform:translateY(-50%)}.about-mandala-right{right:clamp(-222px,-8.6806vw,-89px);transform:translateY(-50%)}.about-compliance-copy{position:relative;z-index:2;text-align:center}.about-compliance h2{max-width:970px;font-size:clamp(62px,6.25vw,160px);line-height:.96;letter-spacing:-.025em;color:var(--gold)}.about-compliance h2 span{display:block}.about-ornament{display:flex;align-items:center;justify-content:center;gap:16px;margin-top:24px}.about-ornament span{width:120px;height:1px;background:rgba(216,159,46,.72)}.about-ornament i{width:8px;height:8px;border:1px solid var(--gold);transform:rotate(45deg)}
.about-process{padding:48px 0 56px}.about-process .about-shell{width:100%}.about-process-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));align-items:stretch;margin-top:12px}.about-process-grid article{height:auto;min-height:260px;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:34px 28px;border-left:1px solid rgba(151,108,34,.3)}.about-process-grid article:first-child{border-left:0}.about-icon-ring{width:122px;height:122px;display:grid;place-items:center;border:1px solid rgba(177,142,57,.65);border-radius:50%;transition:transform .65s cubic-bezier(.22,1,.36,1)}.about-icon-ring svg{width:69px;height:69px;color:#13251B;stroke:currentColor;stroke-width:1.4}.about-process-grid h2{margin-top:16px;color:#13251B;font-size:clamp(29px,2.7083vw,48px);line-height:1.05}.about-process-grid p{max-width:360px;margin-top:10px;font-size:clamp(14px,1.1806vw,18px);font-weight:400;line-height:1.5;color:var(--ink)}
.about-paths{padding:48px 0 56px}.about-paths .about-shell{width:100%}.about-path-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:0;align-items:stretch;margin-top:12px}.about-path-grid article{height:auto;min-height:280px;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:28px 24px;border:1px solid var(--gold-line);border-radius:8px 8px 0 0;text-align:center;color:var(--cream);background:#061E14;transition:transform .32s ease,border-color .32s ease,box-shadow .32s ease}.about-path-grid article:hover{transform:translateY(-5px);border-color:#C49D46}.about-path-grid article.is-featured{order:-1;color:var(--ink);border-color:#C6962C;background:var(--paper);box-shadow:0 18px 40px rgba(0,0,0,.12);transition-delay:0ms}.about-path-grid article.is-featured:hover{transform:translateY(-5px);border-color:#D3A638}.about-path-grid svg{width:78px;height:78px;color:var(--gold);stroke:currentColor;stroke-width:1.4}.about-path-grid h2{margin-top:10px;color:var(--gold);font-size:clamp(28px,2.6389vw,48px);line-height:1.05}.about-path-grid .is-featured h2{color:var(--gold-deep)}.about-path-grid p{max-width:330px;margin-top:9px;font-size:clamp(13px,1.1111vw,17px);font-weight:400;line-height:1.45}.about-path-grid .is-featured p{color:var(--ink)}

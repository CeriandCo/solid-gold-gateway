...
const aboutStyles = `
.about-new{--forest-950:#061B11;--paper:#F2E9D4;--gold:#C9A84C;--gold-line:#B18E39;--gold-deep:#76521B;--cream:#F4ECDA;--ink:#1B1A16;--gutter:clamp(71px,6.9444vw,178px);color:var(--ink);background:var(--paper);font-family:"DM Sans",Arial,sans-serif;font-synthesis:none;-webkit-font-smoothing:antialiased;overflow-x:clip}

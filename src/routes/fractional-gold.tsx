  ...
  return (
    <main id="top" className="fractional-legacy overflow-hidden bg-background">
      ...
      <section className="relative overflow-hidden bg-background" aria-label="Our philosophy">
        <div className="pointer-events-none absolute right-[-10%] top-1/2 h-[520px] w-[520px] -translate-y-1/2 opacity-[0.12] mix-blend-screen sm:h-[620px] sm:w-[620px] lg:right-[-8%] lg:h-[760px] lg:w-[760px]">

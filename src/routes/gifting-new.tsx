...
.gifting-new {
  ...
  --page-max: 1320px; --page-padding: clamp(32px,4.2vw,60px);
...
.gifting-new > header { height: clamp(76px,7.25vw,104px); background: var(--forest-950); animation: giftFade .3s ease both; }
.gifting-new > header > div > div { min-height: clamp(76px,7.25vw,104px); max-width: 1440px; width: calc(100% - 72px); margin-inline: auto; padding-inline: 0; }
.gifting-new > header img { width: clamp(145px,13.9vw,200px); }
.gifting-new > header nav[aria-label="Primary navigation"] { gap: clamp(22px,3.35vw,48px); }
.gifting-new > header nav[aria-label="Primary navigation"] a { font-family: "DM Sans",sans-serif; font-size: clamp(11px,1vw,14px); opacity: .92; }
...
.gift-overline p { font-size: clamp(11px,.97vw,14px); line-height: 1; font-weight: 600; letter-spacing: .18em; }
.gift-overline svg { width: 17px; height: 17px; }
.gift-hero h1 { max-width: 390px; color: var(--cream-text); font-size: clamp(54px,5.28vw,76px); font-weight: 500; line-height: .96; letter-spacing: -.025em; }
.gift-hero h1 span { display: block; }
.gift-hero-body { max-width: 335px; margin-top: 16px; color: rgba(250,245,234,.88); font-size: clamp(13px,1.1vw,16px); font-weight: 400; line-height: 1.55; }
.gift-hero-actions { display: flex; gap: 12px; margin-top: 24px; }
.gift-button { display: inline-flex; align-items: center; justify-content: center; gap: 12px; height: clamp(42px,3.89vw,56px); padding-inline: clamp(20px,1.75vw,25px); border-radius: 3px; font-size: clamp(12px,1.05vw,15px); font-weight: 600; line-height: 1; transition: color .22s,background-color .22s,border-color .22s,transform .22s; }
...
.gift-button-dark { height: clamp(42px,3.75vw,54px); margin-top: 17px; color: var(--cream-text); background: var(--forest-900); }.gift-button-dark svg { color: var(--gold-400); }
...
.gift-benefits { height: clamp(140px,13.75vw,198px); background: var(--cream-150); }
...
.gift-section-overline > span { width: 27px; height: 1px; background: var(--gold-500); opacity: .8; }.gift-section-overline p { font-size: clamp(10px,.76vw,11px); font-weight: 600; letter-spacing: .2em; }.gift-section-overline svg { width: 15px; height: 15px; }
.gift-occasions h2 { margin-top: 5px; margin-bottom: clamp(10px,1.1vw,16px); color: var(--ink); font-size: clamp(29px,2.92vw,42px); font-weight: 500; line-height: 1.05; }
.gift-occasion-grid { width: min(100%,924px); display: grid; grid-template-columns: repeat(6,minmax(0,1fr)); gap: clamp(5px,.49vw,7px); }
...
.gift-personal { height: clamp(332px,32.36vw,466px); display: grid; grid-template-columns: 43% 27% 30%; overflow: hidden; background: var(--cream-200); }
.gift-personal-copy { position: relative; display: flex; align-items: center; overflow: hidden; }.gift-personal-copy > div { position: relative; width: min(300px,68.2%); margin-left: 27.7%; }
...
.gift-personal-overline { gap: 7px; color: var(--gold-deep); }.gift-personal-overline p { font-size: clamp(10px,.76vw,11px); font-weight: 600; letter-spacing: .2em; }.gift-personal-overline svg { width: 14px; height: 14px; }
.gift-personal h2 { margin-top: 7px; color: var(--forest-900); font-size: clamp(32px,3.2vw,46px); font-weight: 500; line-height: 1.02; letter-spacing: -.02em; }.gift-personal h2 span { display: block; }
.gift-personal-body { max-width: 285px; margin-top: clamp(9px,1.04vw,15px); font-size: clamp(12px,1.04vw,15px); line-height: 1.5; }
.gift-personal ul { display: grid; gap: clamp(4px,.48vw,7px); margin-top: clamp(8px,.7vw,10px); }.gift-personal li { display: flex; align-items: center; gap: 7px; font-size: clamp(11px,.9vw,13px); line-height: 1.15; }.gift-personal li > span { width: clamp(14px,1.18vw,17px); height: clamp(14px,1.18vw,17px); flex: none; display: grid; place-items: center; border-radius: 50%; color: var(--cream-text); background: var(--forest-900); }.gift-personal li svg { width: 65%; height: 65%; }
...
.gift-trust { height: clamp(119px,11.67vw,168px); color: var(--cream-text); background-color: var(--forest-950); background-image: linear-gradient(115deg,rgba(255,255,255,.018),transparent 40%),radial-gradient(ellipse at 30% 10%,rgba(201,168,76,.035),transparent 45%); }

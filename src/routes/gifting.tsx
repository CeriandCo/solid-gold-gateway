...
.gifting-new {
  ...
  --cream-50: var(--warm-white); --cream-100: #F8EEE2; --cream-150: #F4E9DB; --cream-200: #EFE4D3;
...
.gift-trust { height: clamp(119px,calc(11.67vw - .5px),298px); color: var(--cream-text); background:
    ...
    radial-gradient(ellipse 48% 38% at 55% 75%, rgba(23,49,38,.08), transparent 58%),
    radial-gradient(ellipse 30% 22% at 92% 82%, rgba(23,49,38,.05), transparent 50%),
    radial-gradient(ellipse 26% 34% at 38% 88%, rgba(23,49,38,.06), transparent 52%),
    linear-gradient(128deg, rgba(217,178,96,.032) 0%, transparent 35%, rgba(217,178,96,.024) 55%, transparent 75%),
    linear-gradient(38deg, rgba(217,178,96,.026) 0%, transparent 28%, rgba(217,178,96,.018) 60%, transparent 85%),
    var(--forest-950); }

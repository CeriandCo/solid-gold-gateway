    ...
    <div className="flex min-h-screen flex-col bg-warm-white">
      ...
      <main className="flex-1">
        ...
        <article className="mx-auto max-w-[720px] px-5 py-14 sm:py-18 lg:py-22">
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">Gold is different.</p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">Gold isn&apos;t one of them.</p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">

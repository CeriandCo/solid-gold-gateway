    ...
    <div ref={scope} className="flex min-h-screen flex-col bg-warm-white">
      ...
      <main className="flex-1">
        ...
        <article className="mx-auto max-w-[720px] px-5 py-14 sm:py-18 lg:py-22">
          <p className="body-copy leading-relaxed text-charcoal/90">
            Buying physical gold online can feel surprisingly simple.
          </p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">Here is what to check.</p>
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">You might be buying:</p>
          <ul className="body-copy leading-relaxed mt-5 list-disc space-y-3 pl-6 text-charcoal/90">
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">These are not interchangeable.</p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">The answer matters.</p>
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">Good gold doesn&apos;t need a countdown timer.</p>
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">Before purchasing, look for a clear breakdown of:</p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">
            Gold value + premium or transaction fee + delivery/storage costs = your actual purchase price
          </p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">Also look at the other side of the transaction.</p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">
          ...
          <p className="body-copy leading-relaxed mt-5 text-charcoal/90">Having the gold delivered gives you direct possession.</p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">Before choosing this option, check:</p>
          <ul className="body-copy leading-relaxed mt-5 list-disc space-y-3 pl-6 text-charcoal/90">
          ...
          <p className="body-copy leading-relaxed mt-5 text-charcoal/90">
            Vaulting can remove the need to keep valuable metal at home, but it creates a different set of questions.
          </p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">Find out:</p>
          <ul className="body-copy leading-relaxed mt-5 list-disc space-y-3 pl-6 text-charcoal/90">
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">What matters is what sits behind those claims.</p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">Trust is stronger when you can verify it.</p>
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">Some warning signs are fairly straightforward:</p>
          <ul className="body-copy leading-relaxed mt-5 list-disc space-y-3 pl-6 text-charcoal/90">
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">Buying is only half the process.</p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">
          ...
          <ul className="body-copy leading-relaxed mt-6 list-disc space-y-4 pl-6 text-charcoal/90">
        ...
        <section className="bg-forest-deep py-14 text-warm-white sm:py-18">
          <div className={WIDE}>
            <div data-reveal className="mx-auto max-w-[720px] text-center">
              ...
              <div className="mt-8">
                <GoldButton to="/early-access" className="h-[54px] px-8">Join the SQOOT Pure waitlist</GoldButton>
              </div>

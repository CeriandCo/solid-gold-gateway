...
@media(max-width:1279px){.kc-container{width:calc(100% - 80px)}.kc-hero-inner{grid-template-columns:minmax(0, 40fr) minmax(0, 60fr);gap:32px}.kc-benefit-grid{grid-template-columns:repeat(3,1fr);height:auto}.kc-benefit-grid article:nth-child(4){border-left:0}.kc-benefits{height:auto;min-height:310px}.kc-returns-panel{grid-template-columns:minmax(0, 40fr) minmax(0, 60fr);height:auto;min-height:558px}.kc-external-grid{height:auto;grid-template-columns:repeat(2,1fr)}.kc-film-card{height:340px}}

...
import { LearnAurumArchive } from "@/components/learn-aurum-archive";
import { fetchEditorialArchive } from "@/lib/aurum-editorial.functions";
...
function KnowledgeCenterPage() {
  ...
  return (
    <main ref={rootRef} id="top" className="knowledge-center-page">
      ...
      <LearnAurumArchive rows={archiveRows} />
...
.knowledge-center-page{--kc-forest-950:#01120d;--kc-forest-900:#021c15;--kc-forest-850:#05291f;--kc-forest-800:#0a3528;--kc-gold:#C9A84C;--kc-gold-dark:#b98224;--kc-gold-soft:#e5c171;--kc-cream:#fcfaf6;--kc-paper:#f8f3ea;--kc-paper-dark:#f1e9dc;--kc-ink:#10261e;--kc-body:#34413c;--kc-muted:#6b726d;--kc-border:rgba(112,87,45,.17);--kc-border-dark:rgba(213,163,59,.28);--kc-shadow:0 2px 6px rgba(21,28,24,.025),0 14px 38px rgba(21,28,24,.075);--kc-radius-large:18px;--kc-radius-card:8px;--kc-radius-small:6px;background:radial-gradient(circle at 12% 18%,rgba(213,163,59,.035),transparent 28%),radial-gradient(circle at 86% 72%,rgba(4,41,31,.025),transparent 32%),#faf7f0;color:var(--kc-ink);overflow-x:clip;font-family:"Inter",Arial,sans-serif;font-weight:400}
.knowledge-center-page *{box-sizing:border-box}.kc-container{width:100%;max-width:var(--container);padding-inline:var(--gutter);margin-inline:auto}.kc-section{margin-top:24px}.kc-display,.kc-hero-copy,.kc-section-title,.kc-promo-card h2,.kc-investing h2,.kc-external-card h2,.kc-film-card h2{font-family:"Cormorant Garamond",Georgia,serif;letter-spacing:-.02em}.kc-display{font-size:clamp(58px,4.8vw,70px);line-height:.98;font-weight:500}.kc-hero-copy{font-size:clamp(32px,2.75vw,40px);line-height:1.08;font-weight:500}.kc-section-title{font-size:clamp(31px,2.5vw,38px);line-height:1.05;font-weight:500}.kc-body{font-size:15px;line-height:1.55}.kc-label{font-size:11px;line-height:1;font-weight:600;letter-spacing:.12em;text-transform:uppercase}.knowledge-center-page a,.knowledge-center-page button{outline-offset:4px}.knowledge-center-page a:focus-visible,.knowledge-center-page button:focus-visible{outline:2px solid var(--kc-gold-soft)}
...
.kc-archive{margin-top:0;padding-block:42px;border-top:1px solid var(--kc-border)}.kc-archive__dek{max-width:720px;margin-top:12px;font-size:15px;line-height:1.55;color:var(--kc-body)}.kc-archive .kc-label{color:var(--kc-gold-dark)}.kc-archive .kc-section-title{margin-top:10px}.kc-archive__controls{display:flex;flex-wrap:wrap;align-items:center;justify-content:space-between;gap:14px;margin-top:22px}.kc-archive__filters{display:flex;flex-wrap:wrap;gap:8px}.kc-archive__filter{padding:9px 16px;border:1px solid var(--kc-border);border-radius:var(--kc-radius-small);background:var(--kc-paper);color:var(--kc-body);font-size:12px;font-weight:600;letter-spacing:.08em;text-transform:uppercase;cursor:pointer;transition:background .2s,color .2s,border-color .2s}.kc-archive__filter:hover{border-color:var(--kc-border-dark)}.kc-archive__filter.is-active{border-color:var(--kc-gold-dark);background:var(--kc-forest-900);color:var(--kc-gold-soft)}.kc-archive__count{font-size:12px;color:var(--kc-muted)}.kc-archive__list{display:grid;gap:10px;margin-top:18px;padding:0;list-style:none}.kc-archive__link{display:grid;grid-template-columns:190px minmax(0,1fr) 24px;align-items:center;gap:18px;padding:18px 20px;border:1px solid var(--kc-border);border-radius:var(--kc-radius-card);background:var(--kc-paper);box-shadow:var(--kc-shadow);transition:border-color .2s,transform .2s}.kc-archive__link:hover{border-color:var(--kc-border-dark);transform:translateY(-1px)}.kc-archive__meta{display:grid;gap:6px}.kc-archive__badge{font-size:10px;font-weight:600;letter-spacing:.14em;color:var(--kc-gold-dark)}.kc-archive__date{font-size:12px;color:var(--kc-muted)}.kc-archive__body{display:grid;gap:6px}.kc-archive__title{font-family:"Cormorant Garamond",Georgia,serif;font-size:22px;line-height:1.12;color:var(--kc-ink)}.kc-archive__summary{font-size:14px;line-height:1.5;color:var(--kc-body)}.kc-archive__action{color:var(--kc-gold-dark);text-align:right}.kc-archive__empty{margin-top:18px;font-size:15px;color:var(--kc-muted)}.kc-archive__more{margin-top:18px;padding:12px 22px;border:1px solid var(--kc-gold-dark);border-radius:var(--kc-radius-small);background:transparent;color:var(--kc-gold-dark);font-size:12px;font-weight:600;letter-spacing:.1em;text-transform:uppercase;cursor:pointer}.kc-archive__more:hover{background:var(--kc-paper-dark)}

    ...
    <div className="flex min-h-screen flex-col bg-warm-white">
      ...
      <main className="flex-1">
        ...
        <article className="mx-auto max-w-[720px] px-5 py-14 sm:py-18 lg:py-22">
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">Not quite.</p>
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">For many people, that convenience is precisely the point.</p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">But it is a different form of ownership.</p>
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">You are buying gold.</p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">Fractional ownership changes that.</p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">
          ...
          <ul className="body-copy leading-relaxed mt-6 list-disc space-y-2 pl-6 text-charcoal/90">
          ...
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">Start with a simpler question:</p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">What do I actually want to own?</p>
          <p className="body-copy leading-relaxed mt-6 text-charcoal/90">

...
import boxedBar from "@/assets/personal-boxed-bar.jpg";
import guideBooks from "@/assets/occasion-achievements.jpg";
import productGold from "@/assets/gifting-hero-product.jpg";
...
const articles = [
  ...
  { title: "CONFIDENCE IN GOLD", copy: "Principles and guidance for trust and safety when investing in gold.", image: boxedBar, alt: "A SQOOT gold bar presented in a dark green box" },
  ...
  return (
    <main ref={rootRef} id="top" className="knowledge-center-page">
      ...
      <section className="kc-section kc-investing"><div className="kc-container kc-investing-panel" data-kc-reveal>
        ...
        <img src={productGold} alt="SQOOT gold bar and coin presentation" width={1200} height={900} loading="lazy" />
      </div></section>

      <section className="kc-section kc-external"><div className="kc-container kc-external-grid">
        <article className="kc-external-card kc-newsletter" data-kc-reveal><div><span className="kc-label">Stay up to date</span><h2>Get weekly insights on gold's performance</h2><p>Follow market context and the forces shaping gold, delivered in a clear weekly briefing.</p><a href="#">Sign Up on Gold.org <ArrowRight /></a></div><img src={guideBooks} alt="Editorial guides and reference books" width={1200} height={800} loading="lazy" /></article>
        <article className="kc-external-card kc-goldhub" data-kc-reveal><div><span className="kc-label">Explore the home of gold research</span><h2>Get the latest insights from the World Gold Council</h2><p>Explore trusted research, market analysis and educational resources about gold.</p><a href="#">Goldhub <ArrowRight /></a></div><img src={laptop} alt="Laptop displaying an institutional gold dashboard" width={1200} height={800} loading="lazy" /></article>

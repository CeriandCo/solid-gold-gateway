...
/* SAFEGUARDS */
.tc-safeguards{height:calc(238*var(--u));padding:0 calc(56*var(--u)) calc(24*var(--u))}
.tc-safeguard-grid{max-width:calc(1328*var(--u));height:calc(214*var(--u));margin:0 auto;display:grid;grid-template-columns:repeat(4,1fr);gap:calc(17*var(--u))}
.tc-safeguard-grid article{display:flex;flex-direction:column;align-items:flex-start;border:1px solid var(--tc-border);border-radius:var(--tc-radius-card);background:rgba(255,255,255,.80);padding:calc(26*var(--u));box-shadow:0 10px 28px rgba(29,34,27,.065);opacity:0;transform:translateY(14px);transition:opacity .6s var(--tc-ease),transform .35s var(--tc-ease),box-shadow .35s var(--tc-ease)}
...
.tc-safeguard-grid h3{margin-top:calc(14*var(--u));font-size:calc(15*var(--u));font-weight:600;line-height:1.2;color:var(--tc-ink)}
.tc-safeguard-grid p{margin-top:calc(10*var(--u));font-size:calc(13*var(--u));font-weight:400;line-height:1.5;color:var(--tc-body)}
